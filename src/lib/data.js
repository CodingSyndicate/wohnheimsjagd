export const data = [
    {
        ...
        question: [
            ...
            "Little Pingu is still learning german. You have to help him by filling the gap in his homework. ________ abladen verboten?"
        ],
        answers: [
            "schutt",
            "rubble",
    ...
    },
    {
        name: "Baum",
        hint: [
            "Folge weiter dem Weg. Nach 3 Laternen befindet sich zu deiner Rechten ein verschraubter Baum.",
            "Follow the path again. After three lanterns there will be a screwed tree on your right."
        ],
        question: [
            "Pingu hat momentan eine sehr schwere Mathehausaufgabe. Der schlaue Era-Pinguin hat die richtige Lösung gefunden und diese ist zufällig die Nummer dieses verschraubten Baumes. Gib die Zahl für Pingu ein und er gibt dir den nächsten Hinweis.",
            "Pingu is having a really hard math homework right now. The really clever Era-Pinguin found the correct answer and luckily it is the number of the screwed tree."
        ],
        answers: [
            "4108",
        ]
